...
public class PatientController {
	...
	protected void initBinder(HttpServletRequest request,
	 ...
	 @RequestMapping(method = RequestMethod.GET, value = "/patient/{id}")
	    public @ResponseBody
	    PatienttbWithBLOBs getById(@PathVariable Long id) {
	        log.debug("get:" + id);
	        PatienttbWithBLOBs bean = patientService.findDataByKey(id);
	        return bean;
	    }
...
//	    }
	    ...
	    public @ResponseBody
	    ComResponse<PatienttbWithBLOBs> add(@RequestBody PatienttbWithBLOBs bean) {
	        if (bean != null) {
	        ...
	        ComResponse<PatienttbWithBLOBs> comResponse = new ComResponse<PatienttbWithBLOBs>();
	        try {
	    ...
	    public @ResponseBody
	    ComResponse<PatienttbWithBLOBs> update(@RequestBody PatienttbWithBLOBs bean) {
	        if (bean != null) {
	            log.debug("update:" + bean.getName());
	        } else {
	    ...
	    public @ResponseBody
	    ComResponse<PatienttbWithBLOBs> delete(@PathVariable Long id) {
	        log.debug("delete:" + id);
	        ComResponse<PatienttbWithBLOBs> comResponse = new ComResponse<PatienttbWithBLOBs>();
	        try {
